---
description: Viết commit message theo chuẩn Conventional Commits.
---

# Commit Message Generator

## Use when: 
User says "commit", "git commit", "save changes", "tạo commit", "viết commit message", or finished a task and wants to commit.
...
4. **Detect type** from changed files/content (see `.claude/skills/git-commit/references/conventions.md`)
